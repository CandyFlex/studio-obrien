...
|----------|-----------|-----------|--------|
| 1 | **Trades / contractor** (roofing or HVAC) | Highest-value local clients; nothing in portfolio proves we speak their language; pairs with future /contractor-trades-website-design page | queued |
...
2. **[C]** Build archetype #1 (trades/contractor) — needs no input, starts on request
